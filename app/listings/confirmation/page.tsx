            ...
            <div className="max-w-2xl mx-auto">
              {isDraft ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-green-600/20 border border-green-500/30 rounded-lg p-5 mt-8 max-w-lg mx-auto">
                    <div className="text-center">
                      <div className="flex items-center justify-center mb-4">
                        <svg className="w-5 h-5 text-green-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <h3 className="text-green-300 font-medium text-sm">What Happens Next?</h3>
                      </div>
          ...
          <div className="max-w-md mx-auto space-y-3">
            {isDraft && listingId && (
              <Link
                ...
                className="btn-primary w-full text-center py-3 font-medium hover-lift block text-sm"
              >
            ...
            <Link
              href="/profile"
              className="glass w-full text-center py-3 font-medium text-white hover-lift border border-neutral-600 block text-sm"
            >
              View My Listings
            </Link>
        ...
        <ScrollAnimation direction="up" delay={100}>
          <div className="max-w-4xl mx-auto mt-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="glass p-6 border border-gold/30 rounded-luxury h-40 flex flex-col justify-between">
                <div>
                  <h3 className="text-lg text-white font-medium mb-3">Need Help?</h3>
                ...
                <Link
                  href="/contact"
                  className="text-gold hover:text-gold-light font-medium transition-colors text-sm mt-4"
                >
                  Contact Support →
                </Link>
              </div>
              ...
              <div className="glass p-6 border border-gold/30 rounded-luxury h-40 flex flex-col justify-between">
                <div>
                  <h3 className="text-lg text-white font-medium mb-3">Browse Other Listings</h3>
                  <p className="text-neutral-400 text-sm">
