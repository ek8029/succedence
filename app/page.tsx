          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <Stack gap="lg">
              <Stack gap="md">
                ...
                <p className="text-body text-text-secondary/80 max-w-xl">
              ...
              <Stack gap="xs">
                ...
                <Stack gap="xs" className="ml-1">
                  <p className="text-label text-text-secondary/60">Free. No signup required. Export PDF immediately.</p>
                  <p className="text-micro text-text-secondary/50">
              ...
              <Stack gap="sm">
                ...
                >
                  <Cluster gap="md" align="start">
                    ...
                    <Stack gap="xs">
                      <div>
                        <p className="text-micro text-accent-color font-medium uppercase tracking-wide mb-1">Data Input</p>
                        <h3 id="step-1-title" className="text-h4 text-text-primary">Input Financials</h3>
                      </div>
                ...
                >
                  <Cluster gap="md" align="start">
                    ...
                    <Stack gap="xs">
                      <div>
                        <p className="text-micro text-accent-color font-medium uppercase tracking-wide mb-1">Risk Analysis</p>
                        <h3 id="step-2-title" className="text-h4 text-text-primary">Review Risk-Adjusted Range</h3>
                      </div>
                      <p className="text-text-secondary text-label">
                ...
                >
                  <Cluster gap="md" align="start">
                    ...
                    <Stack gap="xs">
                      <div>
                        <p className="text-micro text-accent-color font-medium uppercase tracking-wide mb-1">Report Generation</p>
                        <h3 id="step-3-title" className="text-h4 text-text-primary">Export Defensible Reports</h3>
                      </div>
                      <p className="text-text-secondary text-label">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Stack gap="xs" className="border-l-2 border-accent-color/60 pl-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-h3 text-text-primary">Institutional Trust</h3>
                </div>
              ...
              <Stack gap="xs" className="border-l-2 border-accent-color/60 pl-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-h3 text-text-primary">Operational Trust</h3>
                </div>
              ...
              <Stack gap="xs" className="border-l-2 border-accent-color/60 pl-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-h3 text-text-primary">Technical Trust</h3>
                </div>
        ...
        <PageContainer>
          <Stack gap="xl">
            <Stack gap="sm">
              ...
              <p className="text-body-lg text-text-secondary/90 max-w-2xl">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Stack gap="xs" className="border border-text-secondary/20 rounded-lg p-6 bg-text-secondary/5 hover:bg-text-secondary/10 transition-colors">
                <h3 className="text-h4 text-text-primary">Customer Concentration</h3>
                <p className="text-text-secondary/90 text-label">
                ...
                <div className="pt-2 border-t border-text-secondary/20">
                  <p className="text-micro text-text-secondary/70 mb-1">Multiple Adjustment Range:</p>
                  <p className="text-label text-accent-color font-semibold">-0.3x to -1.2x SDE</p>
                </div>
              </Stack>

              <Stack gap="xs" className="border border-text-secondary/20 rounded-lg p-6 bg-text-secondary/5 hover:bg-text-secondary/10 transition-colors">
                <h3 className="text-h4 text-text-primary">Owner Dependency</h3>
                <p className="text-text-secondary/90 text-label">
                ...
                <div className="pt-2 border-t border-text-secondary/20">
                  <p className="text-micro text-text-secondary/70 mb-1">Multiple Adjustment Range:</p>
                  <p className="text-label text-accent-color font-semibold">-0.2x to -1.0x SDE</p>
                </div>
              </Stack>

              <Stack gap="xs" className="border border-text-secondary/20 rounded-lg p-6 bg-text-secondary/5 hover:bg-text-secondary/10 transition-colors">
                <h3 className="text-h4 text-text-primary">Revenue Trajectory</h3>
                <p className="text-text-secondary/90 text-label">
                ...
                <div className="pt-2 border-t border-text-secondary/20">
                  <p className="text-micro text-text-secondary/70 mb-1">Multiple Adjustment Range:</p>
                  <p className="text-label text-accent-color font-semibold">-0.5x to +0.4x SDE</p>
                </div>
              </Stack>

              <Stack gap="xs" className="border border-text-secondary/20 rounded-lg p-6 bg-text-secondary/5 hover:bg-text-secondary/10 transition-colors">
                <h3 className="text-h4 text-text-primary">Recurring Revenue Mix</h3>
                <p className="text-text-secondary/90 text-label">
                ...
                <div className="pt-2 border-t border-text-secondary/20">
                  <p className="text-micro text-text-secondary/70 mb-1">Multiple Adjustment Range:</p>
                  <p className="text-label text-accent-color font-semibold">+0.2x to +0.8x SDE</p>
                </div>
              </Stack>
            </div>
          </Stack>
        ...
        <PageContainer>
          <div className="border-y border-text-secondary/20 py-16">
            <Stack gap="lg" className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-label text-text-secondary/60">Free. No signup required. Export PDF reports immediately.</p>
            </Stack>
          </div>
        </PageContainer>
      </Section>
