      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 lg:py-20 pb-12 sm:pb-16 md:pb-20 lg:pb-24 max-w-7xl">
          ...
          <ScrollAnimation direction="fade" delay={200}>
            <div className="mt-32 mb-0 -mx-4 sm:-mx-6 lg:-mx-8">
              <div className="bg-charcoal border-t border-gold/20 py-16 w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
                <div className="max-w-6xl mx-auto px-4 text-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-8 justify-center items-center mb-12">
                    ...
                    >
                      ...
                      hello@succedence.com
                    </a>
                  </div>

                  <div className="text-sm text-neutral-400 border-t border-gold/10 pt-8">
                    <p>&copy; 2024 Succedence. All rights reserved. Built for discerning business professionals.</p>
                  </div>
                </div>
              </div>
            </div>
