          ...
          <PageContainer>
            <ScrollAnimation direction="fade">
              <Stack gap="lg" className="text-center">
                  ...
                  <div className="mx-auto max-w-4xl">
                    <div className="p-6 rounded-luxury-lg border-2 bg-gradient-to-r from-gold/20 to-accent-gold/20 border-gold/50">
                      <Stack gap="sm" className="items-center">
                        ...
                        <p className="text-off-white/80 text-sm max-w-2xl">
                          Sign in to access full listing details, save searches, and export financial analysis reports.
                        </p>
                        <Cluster gap="xs" wrap className="justify-center">
                          <Link
                            href="/login"
                ...
                <h1 className="font-serif text-4xl md:text-5xl text-warm-white">Business marketplace</h1>
                <p className="font-sans text-xl text-off-white/90">Main street businesses listed for sale</p>
        ...
        <Section variant="default">
          <PageContainer>
            <ScrollAnimation direction="up" delay={50}>
              {/* Analysis Features */}
              <div className="border border-amber/30 p-8 bg-amber/5">
                <Stack gap="lg">
                  <Stack gap="xs" className="text-center">
                    <Cluster gap="xs" align="center" className="justify-center">
                      <h3 className="text-xl font-semibold text-amber">Analysis tools</h3>
                      <Tooltip content="Financial analysis and due diligence checklists for each listing">
                        <svg className="w-5 h-5 text-amber/70 cursor-help" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-off-white/70 text-sm">
                      {isAdmin ? (
                        'Financial analysis, deal scoring, and due diligence checklists for each listing.'
                      ) : (
                        `Your ${SUBSCRIPTION_PLANS[userPlan].name} plan includes ${userPlan === 'free' ? 'no analysis features' : 'analysis tools'}. Upgrade for additional capabilities.`
                      )}
                    </p>
                  </Stack>
                  ...
                  <Stack gap="sm">
                    ...
                    <div className={`flex items-center justify-between p-3 border ${
                      ...
                      <Cluster gap="xs" align="center">
                        ...
                        <span className="text-warm-white font-medium">Financial analysis</span>
                        <Tooltip content="Revenue trends, margin analysis, and growth metrics">
                          <svg className="w-4 h-4 text-off-white/50 cursor-help" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                          </svg>
                        </Tooltip>
                      </Cluster>
                      {!isAdmin && !hasAIFeatureAccess(userPlan, 'businessAnalysis', user?.role) && (
                        <Link href="/subscribe" className="text-xs bg-amber/20 text-amber px-2 py-1 border border-amber/30 hover:bg-amber/30 transition-colors">
                          Upgrade
                        </Link>
                      )}
                    </div>
                    ...
                    <div className={`flex items-center justify-between p-3 border ${
                      ...
                      <Cluster gap="xs" align="center">
                        ...
                        <span className="text-warm-white font-medium">Deal quality scoring</span>
                        <Tooltip content="Risk assessment and pricing reasonableness">
                          <svg className="w-4 h-4 text-off-white/50 cursor-help" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                          </svg>
                        </Tooltip>
                  ...
                  {/* AI Disclaimer */}
                  <div className="p-4 bg-navy/20 rounded-lg border border-gold/10">
            ...
            {isDemoMode ? (
              ...
              {listings.length === 0 ? (
                <Stack gap="lg" className="text-center">
                  ...
                  {/* Heading */}
                  <h3 className="text-3xl font-semibold text-warm-white">
                    No matches for those filters
                  </h3>

                  {/* Description */}
                  <p className="text-platinum/80 max-w-2xl mx-auto text-lg">
                ...
                <div className="glass p-6 rounded-luxury-lg border border-gold/20 h-full flex flex-col">
                  ...
                  {/* CTAs */}
                  <Cluster gap="sm" wrap className="justify-center">
                    <button
                      onClick={() => {
                  ...
                  {/* Encouragement */}
                  <div className="p-6 bg-gold/5 border border-gold/20 rounded-luxury-lg max-w-2xl mx-auto">
                  ...
                  <Stack gap="lg" className="text-center">
                    <div className="glass p-12 rounded-luxury-lg border-2 border-gold/40 bg-gradient-to-br from-gold/10 to-transparent max-w-3xl mx-auto">
                      <Stack gap="lg">
                        ...
                        <p className="text-silver/90 max-w-xl mx-auto text-lg">
