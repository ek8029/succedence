  ...
  try {
    ...
    return NextResponse.json({
      listing: {
        ...
        contact_other: listingData.contact_other,
        source_url: listingData.source_url,
        source_website: listingData.source_website,
        source_id: listingData.source_id,
        broker_name: listingData.broker_name,
        broker_company: listingData.broker_company,
        broker_phone: listingData.broker_phone,
        broker_email: listingData.broker_email,
